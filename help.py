...
class Help:
    def __init__(self, root):
       ...
       #BG IMAGE
        ...
        #label
        title_lbl=Label(self.root,text="HELP",font=("time new roman",28,"bold"),bg="black",fg="white")
        ...
        b1_1=Button(bg_img, text="Email: ayushmanpatra019@gmail.com",cursor="hand2",font=("time new roman",16,"bold"),bg="white",fg="black")
        b1_1.place(x=405,y=170,width=400,height=40)
        
        b1_1=Button(bg_img, text="Email: swatijain19998@gmail.com",cursor="hand2",font=("time new roman",16,"bold"),bg="white",fg="black")
        b1_1.place(x=405,y=230,width=400,height=40)
